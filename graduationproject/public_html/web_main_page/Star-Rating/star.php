...
<br>
    <div class="box-result">
    	<?php
        	$query =mysqli_query($connect,"SELECT * FROM star");
...
<button style="margin-left:45% ; width: 100px;height: 30px;font-weight: bold; background-color: #ffc107;border:solid #533f03"><a href="../Services.php" >back</a>
</button>
</body>
</html>